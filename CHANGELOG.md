...
## [Unreleased](https://github.com/RCIC-UCI-Public/buildtools-admix/compare/2.5...HEAD)

### Commits

- update copyright [`7b50b5f`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/7b50b5f2b1f1d434f7e695bd3ace5ac112551556)
- use actual rpm size [`9692831`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/9692831afb81466321200abd42b09996ef07f016)
- Adjust parallel sets to build 3 sets at a time. [`4d13879`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/4d138790bfed146e0bd3837b35423702305dcf9a)
- Errant ../sources in metadata file. Should be just sources [`434da48`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/434da48674250488aacc62eb441fba65238910c7)
- add cmake 4.2.3 to rpm db [`d5393c6`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/d5393c632bc33664dc0812d6fd5821aafd68f618)
- add lates cmake v.4.2.3 [`48def62`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/48def62fc006e360d12cab0b37c899e223b89ea4)
- update rpmdb for rocky 9.7 [`ff6f39e`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/ff6f39eaf16d326144e70c7bb65df91b83d2385f)
- rm  extra output line [`b2cb68e`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/b2cb68ebb3b80e9adfdac0994d22825246df68de)
- update rpmdb info for buildtools-admix. Add a few new rpms [`a616d8b`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/a616d8b31c85067f22f307298b64579f53f04331)
- Build apptainer (Singularity replacement). Needed updated version of go. [`8ab34d7`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/8ab34d7722b5d3634d5245b670aaef14de586090)
- add admix expected rpms sizes [`5d52934`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/5d529344e36f1213d077c6976c2db5e517453752)
- ignore build stage directories [`603d9b5`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/603d9b57e80ce9f602cb54906fa9b72889e75d74)
- minor short description update [`965e86c`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/965e86cab2ad61b2773149615ff6baf9ecb4b7af)
- The first statement of the description shdold [`2c0e2d9`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/2c0e2d9c8a1a804c8250d3305ef8d1258719db57)
- archive old unused protobuf-classic [`56c8f3f`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/56c8f3fc0a4715a5e04157130453c699411211ad)
- Remove tk module, unused, and it is a copy of tcl module. [`3e663e5`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/3e663e52f33751b42223048c462d4a3e0f48533f)
- Both centos8 and base set depend on go 1.17 being built and installed. [`df69f57`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/df69f57f82a1452a2df7b2ad5491d9d88089956a)
- need to bootstrap first (install system RPMS) then create [`20c4a38`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/20c4a3853e7842aad66a596197fd038dbb96b2d8)
- Remove openmpi-module.yaml only in veryclean target. [`cba718c`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/cba718c45326f856dafec9f2137d0dffc5601d0b)
- the singularity set depended on the base set being bootstrapped.  Merge [`4d0e4d0`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/4d0e4d0a9d32a0d5ab5eb04b3fcd1cecab3a6263)
- With parallel build, $(PKGS) is empty if no set is specified --&gt; [`d4900ee`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/d4900ee73bea89cdf43713eac1dc8ca691c93956)
- add base set. [`f2a50e3`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/f2a50e3f2d23203350a2180278dd876b6b1cc3bc)
- create cmake3 as a link to cmake [`cf75684`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/cf75684f3798508853ff3e9aca1fcd40da2d70d1)
- reorder some variables prepend sequences. Verified via [`de57f67`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/de57f676fd72b700b3aa79287ff3ebf1b4ce6e2b)
- make module for intel-tbb a common one. [`be54b2e`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/be54b2e7036326033ff6628dc1d7013aada8deaf)
- rename to tbbversion, as this only relates to tbb [`97f0b39`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/97f0b39855012c93b565a9dc265d0ecca663d4c9)
- Create a tbb module that just references the subset of intel OneAPI [`ae45ae4`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/ae45ae40a9c1bfeba5da34402ca1781236181da1)
- remove OS 7 related checks. [`cecccc9`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/cecccc9b083e0eb268b123adbf3eca6bef989e19)
- add CXXFLAGS='Wl,-rpath=/lib64' to ninja and cmake builds. This is so [`5e0b11e`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/5e0b11e057b252a75c4a50b7c2c160709d34f515)
- update the if statement for the --with-libssh configure argument to be [`5b944db`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/5b944db91a4f02fe448a5321057b4dac5a699deb)
- Can't use intel-tbb version 2021 because nothing provides the specific [`5b99cd1`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/5b99cd1524a3a4dd88c16ca5d09896a09d46b975)
- add hwloc-devel for Rocky 9 [`4c635e0`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/4c635e01ce6371787432f3d1fb5d623a1087be8f)
- on 8 and 9, install libssh-devel. Was coded for 8 else it would install [`fb22c74`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/fb22c74b8b5fdd821838897e76b1f8a154695c71)
- add admix name [`b4cf761`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/b4cf761df3dc98dac1631078daea0b5694e89877)
- consolidate sets [`3cc8b8d`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/3cc8b8d534a1527cbf5d92eef9a477170776162b)
- add cmake, curl, ninja. moved from foundaiton-admix [`e8ae308`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/e8ae308cf38d61439e8edab679c7d166255ba61c)

## [2.5](https://github.com/RCIC-UCI-Public/buildtools-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog before tagging [`1c05759`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/1c05759145f7ede78085a799dd4bad981f3614b9)
- during the initial build of nodejs there is no node command installed on the system [`73fa465`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/73fa46592f1a8e5e0a663858d6e72338fa51c94a)
- put singularity back. Need this version for many packages [`1f0a7eb`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/1f0a7ebb93dc33ee0b1fe808e50cee799c1e5665)
- Put back bindfs after Nadya found missing build dependencies [`3ade152`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/3ade15205be5bcd2ec425780cc8c2bdc8a03ce82)
- add automake and libtool rpms to build bindfs. [`d263321`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/d263321b1187d133bd7a12837a9637a920b97a80)
- bindfs is a problem child and not needed yet. [`196dfe3`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/196dfe39ddc4b1e99ef605d6be04fc89e027b32a)
- Don't download (or build) an old version of singularity. Is not compatible with [`8fc38f0`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/8fc38f07f2c87104e199856722f3962fac1412f0)
- Add bindfs so that one can do fuse-based bind mounts (works in a singularity container) [`32bf86a`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/32bf86aaf0c82a109caa0876f0a323bfd3a93224)
- nodejs can only have one version installed .. for now have this specified in the 2023 set [`ed0cde9`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/ed0cde947058ed7036ccfd14fed6a794b3819c82)
- Add nodejs v21.4.0 to metadata [`ced3681`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/ced3681b607a32208de95c831eb52220bcfca0fa)
- Only build setuptools, protobuf on 7 [`a39cf2b`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/a39cf2b776f8722749570934c9caf2a08a81bde3)
- add openmpi-devel to system bootstrap [`8056f7e`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/8056f7e4b97878d71e0f5ed472bb124f1380a77e)
- update location of openmpi modulefile for 9 (same as 8) [`faab717`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/faab71725e7783842f514578732804587cbdf8a7)
- update CHANGELOG [`8e6640a`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/8e6640ab36d55e063caffe904fa0e776b0c731d9)
- keep for a reference [`deb1c27`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/deb1c27b90f3029a0865336170de582773ad829e)
- add go 1.22.3. Needed updated ersion for rebuilding newer git-lfs [`0f25fb3`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/0f25fb30bb330e987491101f844dd6b1b636d431)
- lz4 provided static lib needed by unused sambamba [`e5bf390`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/e5bf39020823834ca49eda91ad280cbe4768fb4d)
- enable final location [`39f6a36`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/39f6a3636b1d35c0fcddf7db4758f114dbf917d5)
- add module for latest intel oneapi compiler (2024) [`6b7ebc5`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/6b7ebc5cd77e269171ffd53677b42193e12d1592)
- rm unused lz4 [`932a83f`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/932a83fde169f1e5bad2f3792a11539b74b20e67)
- rm unused packages [`6d8d86f`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/6d8d86f9ea2184063509cfa51b34177074719004)
- add newer nodejs [`6ab8b8a`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/6ab8b8acfdd8dd7c100ecc23e68808ed5c7240f1)
- use regular rpm.extras definitions from rpm.yaml. [`2d47b5b`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/2d47b5b3034b52bff7542db52779b95118be6be8)
- add auto-changelog generated CHANGELOG.md [`7b95976`](https://github.com/RCIC-UCI-Public/buildtools-admix/commit/7b95976f68def38d9065f757b18ef9f3e51ac0ed)
